...
#define AFE_MEM_SIZE_2MICS (126000)
#define AFE_MEM_SIZE_3MICS (182000)
#else
#define AFE_MEM_SIZE_2MICS (48000)
#define AFE_MEM_SIZE_3MICS (77000)
#endif /* !AMP_LOOPBACK_DISABLED */
#elif WAKE_WORD_MAX_LENGTH_MS <= 3000
#if !AMP_LOOPBACK_DISABLED
#define AFE_MEM_SIZE_2MICS (152000)
#define AFE_MEM_SIZE_3MICS (231000)
#else
#define AFE_MEM_SIZE_2MICS (74000)
#define AFE_MEM_SIZE_3MICS (126000)
#endif /* !AMP_LOOPBACK_DISABLED */
#else
