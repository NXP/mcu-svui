...
#ifndef DSMT_EN_EN_STRINGS_DSMT_H_
#define DSMT_EN_EN_STRINGS_DSMT_H_
...
const char * const cmd_change_demo_en[] = {
        "Elevator",
        "Washing Machine",
        "Smart Home",
};
...
const char * const cmd_washing_machine_en[] = {
        "Delicate",
        "Normal",
        "Heavy duty",
        "Heavy duty ^1",
...
const char * const cmd_smart_home_en[] = {
        "Turn on the lights",
...
#endif /* DSMT_EN_EN_STRINGS_DSMT_H_ */
